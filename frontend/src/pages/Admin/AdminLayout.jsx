        ...
        <nav className="mt-8">
          <ul>
            ...
            <li>
              ...
              >
                <img src={assets.add_icon} alt="Users Icon" className="h-6 w-6 mr-3" />
                Users
              </NavLink>
            </li>
            <li>
              ...
              >
                <img src={assets.parcel_icon} alt="Products Icon" className="h-6 w-6 mr-3" />
                Products
              </NavLink>
            </li>
            <li>
              ...
              >
                <img src={assets.add_icon} alt="Product List Icon" className="h-6 w-6 mr-3" />
                Product List
              </NavLink>
            </li>
          </ul>
