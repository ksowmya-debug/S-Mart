        ...
        <div className="p-6 bg-gray-100 min-h-screen">
            ...
            {summary && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                    <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 flex items-center justify-between">
                        <div>
                            <h2 className="text-lg font-semibold mb-2">Total Profit</h2>
                            <p className="text-3xl font-bold">${summary.totalProfit.toFixed(2)}</p>
                        </div>
                        <img src={assets.logo} alt="Profit Icon" className="h-12 w-12" />
                    </div>
                    <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 flex items-center justify-between">
                        <div>
                            <h2 className="text-lg font-semibold mb-2">Total Users</h2>
                            <p className="text-3xl font-bold">{summary.userCount}</p>
                        </div>
                        <img src={assets.add_icon} alt="Users Icon" className="h-12 w-12" />
                    </div>
                    <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 flex items-center justify-between">
                        <div>
                            <h2 className="text-lg font-semibold mb-2">Total Products</h2>
                            <p className="text-3xl font-bold">{summary.productCount}</p>
                        </div>
                        <img src={assets.parcel_icon} alt="Products Icon" className="h-12 w-12" />
                    </div>
                    <div className="bg-gradient-to-r from-red-500 to-red-600 text-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 flex items-center justify-between">
                        <div>
                            <h2 className="text-lg font-semibold mb-2">Total Orders</h2>
                            <p className="text-3xl font-bold">{summary.orderCount}</p>
                        </div>
                        <img src={assets.order_icon} alt="Orders Icon" className="h-12 w-12" />
                    </div>
                </div>
            )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    <h2 className="text-xl font-bold text-gray-800 mb-4">Top Selling Products by Revenue</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    <h2 className="text-xl font-bold text-gray-800 mb-4">Popular Products by Quantity</h2>
