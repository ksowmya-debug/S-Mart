            ...
            <div className="mt-10 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-2 xl:gap-x-8">
                <div className="group relative">
                    <div className="w-full h-80 rounded-lg overflow-hidden group-hover:opacity-75 sm:h-96">
                        <img src={`${import.meta.env.VITE_BACKEND_URL}/images/${products.find(p=>p.category==='Men')?.image?.[0]}`} alt="Men's Collection" className="w-full h-full object-center object-cover" />
                    </div>
                ...
                <div className="group relative">
                    <div className="w-full h-80 rounded-lg overflow-hidden group-hover:opacity-75 sm:h-96">
                        <img src={`${import.meta.env.VITE_BACKEND_URL}/images/${products.find(p=>p.category==='Women')?.image?.[0]}`} alt="Women's Collection" className="w-full h-full object-center object-cover" />
                    </div>
                    <h3 className="mt-4 text-base font-semibold text-gray-900">
                        <Link to="/Collections">
                            <span className="absolute inset-0" />
